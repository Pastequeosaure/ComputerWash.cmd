...
set "ARISP32=%%SRESET%% - Example.cmd A1 S1 C55   → Pre-select options and START the program."
set "ARISP33=%%SRESET%% ⚠️ Warning: C55 will execute the selected actions. Make sure you reviewed them first!"
set "ARISP34= "
