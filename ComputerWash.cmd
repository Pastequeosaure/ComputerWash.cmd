...
:: |______________________________________________________|
:: |                                           |          |
:: | Created : PastequeOsaure V 0.0 -> V 6.0.3 | 28/09/19 |
:: |___________________________________________|__________|
:: |                                           |          |
:: |    Edit by : PastequeOsaure V 6.0.3       | 18/03/23 |
:: |                                           |          |
:: |    Participation :                        |          |
:: |    |--------------------------------------|          |
...
echo|set /p="%SFCBLACK%.|                                 %SFCBLACK%|  %NFCYELLOW%S%SRESET%13) Windows Recovery          %SFCBLACK%|             %NFCYELLOW%%SUNDERLINE%S%SRESET%%SUNDERLINE%TATUS%SRESET%              %SFCBLACK%|"
echo.

echo|set /p="%SFCBLACK%.|  %SRESET%COLOR%SRESET%) COLOR ON / OFF          %SFCBLACK%|                                 |                                 |"
echo.

echo|set /p="%SFCBLACK%.|  %NFCYELLOW%HELP%SRESET%)  HELP                    %SFCBLACK%|  %NFCYELLOW%USB%SRESET%) Protec USB                %SFCBLACK%|      %SFCBLUE%**********************     %SFCBLACK%|"
echo.

echo|set /p="%SFCBLACK%.|_________________________________|_________________________________|%SFCBLUE%      * %SRESET%Progress           %SFCBLUE%*%SFCBLACK%     |"
echo.
if /I "%Progress%"=="100" (
...
echo.
echo|set /p="%SFCBLACK%.|                                 |                                 %SFCBLACK%|   _ _ _ _ _ _ _ _ _ _ _ _ _ _   |"
echo.
...
echo.
echo|set /p="%SFCBLACK%.\___________________________________________________________________|_________________________________/%SRESET%"
echo.
echo.
...
cls
echo.
echo|set /p="%SRESET%  ______________________________           Computer Wash Ultimate V OK.6.2 "
echo.
echo|set /p="%SRESET% |\                             \                                                       ============================ "
echo.
echo|set /p="%SRESET% | \                             \          Edit by :: PastequeOsaure V OK.6.2          |       16/04/2022         | "
echo.
echo|set /p="%SRESET% |  \                             \         Created :: PastequeOsaure V 0.0 -> V BT.6.3 | 17/09/2019 -> 26/11/2022 | "                                          
echo.
...
echo.
echo|set /p="%SRESET%      A4  - Last Resort Wash                  - chkdsk defrag cleanmgr DISM sfc findstr defender ipconfig wsreset del "
echo.
echo|set /p="%SRESET%     "
echo.
...
echo.
echo|set /p="%SRESET%      S4  -  Disk Cleanup                     - defrag cleanmgr "
echo.
...
echo.
echo|set /p="%SRESET%      C2  - Disk optimization                 - defrag cleanmgr "
echo.
...
echo.
echo|set /p="%SRESET%      O3  - security                          - Security "
echo.
echo|set /p="%SRESET%      O4  - HELP                              - Help "
echo.
echo|set /p="%SRESET%      O5  - COLOR                             - Color "
echo.
echo.
